...
st.markdown("""
    ...
    /* Main App Background (Mocha) */
    .stApp { 
        background-color: #D2B48C; 
    }
    
    /* Global Bold Rounded Font - Primary text is Black */
    ...
    /* Set internal containers to Light Mocha with Black Text */
    ...
    /* Target the file uploader dropzone border */
    [data-testid="stFileUploadDropzone"] {
        border: 2px dashed #3E2723 !important;
    }

    /* Data Table Styling: Light Mocha background with Black text */
