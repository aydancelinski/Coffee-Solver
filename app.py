...
if uploaded_file:
    try:
        ...
        # FIXED MAPPING: Prioritize Detail over ID to restore Item Names
        name_map = {}
        for c in df.columns:
        ...
        # Drop duplicates to ensure a 1-dimensional item column for groupby
...
if df is not None:
    ...
    # Normalize Volume to a 30-day window
...
# 6. RESTORED DOCUMENTATION & BIO LAYOUT
st.divider()
...
with doc_col1:
    ...
    st.write("""
    The Celinski Coffee Solver was developed to bridge the gap between raw Point-of-Sale (POS) data and 
    actionable business strategy. As an Economics student, I recognized that small business owners often lack 
    the tools to perform complex price elasticity tests. This application automates that analysis to maximize 
    revenue through data-driven recommendations.
    """)
